...
const translations = {
  ru: {
    ...
    home: { tagline: 'Твой центр управления студенческой жизнью. Следи за расписанием, вступай в клубы и находи команду мечты.', news_title: 'Новости Колледжа', meetings: 'Встречи', in_minutes: 'Через 15 мин', popular_clubs: 'Популярные клубы', no_classes: 'Нет пар', upcoming: 'Предстоящее', time: { minutes: 'мин', hours: 'ч', days: 'дней', weeks: 'недель', months: 'мес', years: 'лет' } },
  ...
  en: {
    ...
    home: { tagline: 'Your student life control center. Follow the schedule, join clubs and find your dream team.', news_title: 'College News', meetings: 'Meetings', in_minutes: 'In 15 min', popular_clubs: 'Popular clubs', no_classes: 'No classes', upcoming: 'Upcoming', time: { minutes: 'min', hours: 'h', days: 'days', weeks: 'weeks', months: 'months', years: 'years' } },
