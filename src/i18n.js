...
const translations = {
  ru: {
    sidebar: { home: 'Главная', clubs: 'Клубы', projects: 'Проекты', activity: 'Моя Активность', parliament: 'Парламент', schedule: 'Встречи', profile: 'Профиль', chat: 'Чат', admin: 'Администрация' },
    ...
    common: { create: 'Создать', cancel: 'Отмена', at: 'в', details: 'Подробнее', close: 'Закрыть', save: 'Сохранить', access_denied: 'Доступ запрещён', empty_state: 'Здесь пока ничего нет' },
    ...
    login: { welcome: 'Добро пожаловать в College Hub! 👋', placeholder_first: 'Имя', placeholder_last: 'Фамилия', submit: 'Войти', instructions: 'Введите ваши данные для доступа', student_id_label: 'Student ID', student_id_placeholder: 'Например: 210105', no_id_help: 'Нет ID? Обратитесь в деканат.', errors: { required: 'Обязательное поле', min_chars: 'Должно быть минимум 2 символа', id_invalid: 'ID должен состоять минимум из 5 цифр' } },
    home: { tagline: 'Твой центр управления студенческой жизнью. Следи за расписанием, вступай в клубы и находи команду мечты.', news_title: 'Новости Кампуса', meetings: 'Встречи', in_minutes: 'Через 15 мин', popular_clubs: 'Популярные клубы', no_classes: 'Нет пар', upcoming: 'Предстоящее', time: { minutes: 'мин', hours: 'ч', days: 'дней', weeks: 'недель', months: 'мес', years: 'лет' } },
    news: { author: { council: 'Студенческий Совет', robotics_club: 'Клуб Робототехники' }, time: { '2h': '2 часа назад', '5h': '5 часов назад' }, content: { hackathon: "🎉 Приглашаем всех на ежегодный хакатон 'Campus Code 2025'! Регистрация открыта до пятницы.", robotics_recruit: 'Ищем инженеров в команду для подготовки к битве роботов. Опыт не важен, главное желание учиться!' } },
  ...
  en: {
    sidebar: { home: 'Home', clubs: 'Clubs', projects: 'Projects', activity: 'Activity', parliament: 'Parliament', schedule: 'Schedule', profile: 'Profile', chat: 'Chat', admin: 'Administration' },
    ...
    clubs: {
      ...
      descriptions: { debate: 'The art of debate and rhetoric.', eco: 'Making our campus greener.', art_studio: 'Drawing, design and exhibitions.', tech_innovators: 'Software development and gadgets.' },
    ...
    common: { create: 'Create', cancel: 'Cancel', at: 'at', details: 'Details', close: 'Close', save: 'Save', access_denied: 'Access denied', empty_state: 'Nothing here yet' },
